    ...
    <el-row type="flex" justify="end">
      <el-col :span="12">
        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" style="display: inline-block"
          ...
          <el-menu-item index="0" style="color:#f36c60; font-size:28px;">ACGFAN</el-menu-item>
          <el-menu-item index="1" style="color:#f36c60;font-size:10px;">主站</el-menu-item>
      ...
      <el-col :span="12">
        <el-menu :default-active="'8'" class="el-menu-demo" mode="horizontal" style="display: inline-block;float: right;"
                 @select="handlerSelect">
