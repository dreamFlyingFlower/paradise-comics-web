<template>
  <div>
    ...
    <el-form label-width="120px" :model="formData" :rules="rules" ref="formData">
      <el-row>
        <el-col :span="12">
          <el-form-item label="用户名:"><input v-model="formData.username" style="width:80%;" /></el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="生日:"><input v-model="formData.userinfo.birthday" style="width:80%;" /></el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="教育程度:"><input v-model="formData.userinfo.education" style="width:80%;" /></el-form-item>
        </el-col>
        <el-col :span="12">
